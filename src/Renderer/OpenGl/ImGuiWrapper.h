...
void ImGuiStyleCorporateGrey();
void ImGuiStyleVisualStudio();
...
inline void ImGuiInit(GLFWwindow* windowPtr)
{
	...
	ImGuiStyleCorporateGrey();
	// ImGuiStyleVisualStudio();
...
inline void ImGuiStyleCorporateGrey()
{
...
inline void ImGuiStyleVisualStudio()
{
